...
DECLARE_GL_PROC(PFNGLACTIVETEXTUREPROC, _glActiveTexture);
#endif
...
#define IMPORT_GL_PROC(type, name) \
  ...
  IMPORT_GL_PROC(PFNGLGENVERTEXARRAYSPROC, glGenVertexArrays);
  IMPORT_GL_PROC(PFNGLBINDVERTEXARRAYPROC, glBindVertexArray);
  IMPORT_GL_PROC(PFNGLVERTEXATTRIBPOINTERPROC, glVertexAttribPointer);
  IMPORT_GL_PROC(PFNGLENABLEVERTEXATTRIBARRAYPROC, glEnableVertexAttribArray);
  IMPORT_GL_PROC(PFNGLGENBUFFERSPROC, glGenBuffers);
  IMPORT_GL_PROC(PFNGLBINDBUFFERPROC, glBindBuffer);
  IMPORT_GL_PROC(PFNGLBUFFERDATAPROC, glBufferData);

#if defined(__WIN32__)
  //IMPORT_GL_PROC(PFNGLACTIVETEXTUREPROC, _glActiveTexture);
#endif
